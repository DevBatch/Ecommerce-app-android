...
/**
 * Created by Irfan on 3/9/2017.
 */

public class LoadingSquaredImageView extends SquareImageView {
    private boolean isLoading = false;
    private int width, height, x, y, rX, rY, rWidth, rHeight;
    private Paint loadingPaint;
    private Paint ripplePaint;

    public LoadingSquaredImageView(Context context) {
        super(context);
        init(context);
    }

    public LoadingSquaredImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
